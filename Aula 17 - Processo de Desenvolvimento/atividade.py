...
root = tk.Tk() # Janela
root.geometry('1700x750') # Tamanho da janela
root.iconbitmap('16-client-cat_icon-icons.com_76692.ico')
...
btn = tk.Button(root, text= 'envia para o shell', command=mostrar_shell)
btn.pack(pady = 20)
