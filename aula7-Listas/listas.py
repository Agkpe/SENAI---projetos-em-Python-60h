...
# ações
# menor valor - quando aplicado a uma lista de método string, fica mais próxima de A
print(min(lista))
# maior valor - Quando STR fica mais prox de Z
print(max(lista))
# comprimento da lista - Não conta a partir de indices, conta a quant.
