...
carrinho = []   # lista vaga para receber os dados postos no INPUT
meu_valor = []   # lista vaga para receber os dados postos no INPUT
print('***' * 20)
print(f'''
PRODUTOS:
ID            PRODUTOS       VALOR R$
...
#add o produto transcrito pelo ID, da lista dos produtos até a lista vazia do carrinho
