...
pygame.display.set_caption('JOGO DO DINO') # coloca títulos na tela do jogo
...
#LÓGICA DE PENSAMENTO DE POSICIONAMENTO
'''Em jogos 2D, o personagem ao andar para esquerda e para cima, o número do movimento a ser colocado deve ser negativo, pois os valores para essa direções estão indo em direção ao zero.
Agora, quando o personagem se move para a direita e para baixo, o valor se torns positivo, se aproximando ao valor total dos pixels colocados, ou seja
      0______
     0|______|800
            200
'''
